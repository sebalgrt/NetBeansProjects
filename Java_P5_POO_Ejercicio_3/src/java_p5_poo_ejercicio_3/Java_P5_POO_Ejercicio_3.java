 ...
 * @author Lichi y Fran
 */
public class Java_P5_POO_Ejercicio_3 {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        Operacion carga = new Operacion(0,0);
        carga.crearOperacion();
        System.out.println("El resultado de la suma es: " + carga.sumar());
        System.out.println("El resultado de la resta es: " + carga.restar());
        System.out.println("El resultado de la multiplicación es: " + carga.multiplicar());
        System.out.println("El resultado de la división es: " + carga.dividir());
    }
